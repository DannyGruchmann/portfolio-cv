...
/** Native <dialog>-based modal listing all projects, grouped into category tabs. Opened imperatively via open() from ProjectsSection. */
@Component({
...
export class ProjectsDialog {
  ...
  // Groups PROJECTS by category and drops empty categories, so a tab never renders
  // with zero projects in it.
